<form action="" method="post" autocomplete="on" id="statusForm">
    <input type="hidden" name="id" id="id">
    <div class="modal fade" id="statusDocument" tabindex="-1" aria-labelledby="statusDocumentLabel" aria-hidden="true" data-bs-backdrop="static">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="statusDocumentLabel">ປ່ຽນສະຖານະເອກະສານ</h5>
